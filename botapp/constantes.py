...
MSG_GMAPS_OK = [
    ...
    "Voilà, voilà : ",
    "Oh mais oui, regarde : ",
    "Ma mémoire n'est plus ce qu'elle était mais j'ai trouvé ça : ",
    "Et ... Ah! mais si, voilà : "
]
...
MSG_WIKI_OK = [
    ...
    "Et d'ailleur, savais tu que ... ",
    "Je me rappel de quelque chose qui pourrait t'intéresser ... ",
    "Si tu as le temps, je me rappel d'nue petite histoire ... ",
]


MSG_FAIL = [
    "Mince, je n'ai rien à ce sujet ... L'orthographe de ta recherche est correct ? ",
    "Pardi, je n'ai rien à ce sujet ! Vérifie l'orthographe peut être. ",
    "Ma mémoire me fait défaut... ou ton orthographe n'est pas bon... Vérifie au cas ou :) "
]
...
STOP_WORDS = ["a", "abord", "absolument", "afin", "ah", "ai", "aie", "ailleurs", "ainsi", "ait", "allaient", "allo",
              ...
              "être", "ô", "salut", "bonjour", "grandpy", "grandpybot", "grand", "gran" "papy", "py", "bot", "adresse", "connais",
                "montre", "montrer", "trouve", "trouver", "trouvé", "trouvez", "trouvais", "trouvait", "trouvaient"]
